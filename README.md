...
<details>
<summary><b>🧘 LIFE Hub — Personal Productivity & Wellness App · React · Node.js · PostgreSQL · Docker</b></summary>
...
<details>
<summary><b>📝 Next.js Blog CMS — Next.js · TypeScript · Tailwind CSS · Markdown · SSG/SSR</b></summary>
...
**UI/UX Designer Intern** · Cod Soft Technologies
`Aug 2025 – Oct 2025` · `Figma · HTML · CSS`

- Designed wireframes, mockups, and high-fidelity prototypes for 3+ web and mobile app screens; reduced developer revision cycles by ~30% by resolving design ambiguity before handoff.
- Audited 20+ UI components for WCAG 2.1 AA accessibility compliance, iterating on visual hierarchy to improve readability and user flow.
- Collaborated with a 5-person cross-functional team to translate Figma specs into pixel-accurate HTML/CSS implementations maintaining brand consistency.
...
![CSS](https://img.shields.io/badge/CSS-4F46E5?style=flat-square&logo=css3&logoColor=white)
![WCAG](https://img.shields.io/badge/WCAG_2.1_AA-5B21B6?style=flat-square)

---

**Web Developer Intern** · Coding Samurai
`Aug 2025 – Sep 2025` · `HTML · CSS · JavaScript · Python/Flask · RESTful APIs`

- Built 2 responsive client-facing features on schedule within a 2-week Agile sprint, improving cross-device compatibility.
- Integrated 3 RESTful APIs for dynamic data rendering; resolved 5 frontend–backend integration bugs through root-cause analysis, cutting open defect count by 40% that sprint.
- Communicated progress and blockers daily in standups in a remote-first Agile environment.
...
![REST APIs](https://img.shields.io/badge/RESTful_APIs-4F46E5?style=flat-square)
![Agile](https://img.shields.io/badge/Agile%2FScrum-5B21B6?style=flat-square)

---

**Developer Intern** · HJAUTECH
`Jul 2025 – Sep 2025` · `Git · Agile/Scrum · Full SDLC`

- Contributed across the full SDLC — requirements, coding, testing, and deployment — as 1 of 4 developers; maintained 100% on-time sprint delivery across all 4 sprints.
- Enforced Git branching conventions and led peer code reviews, improving codebase consistency and reducing merge conflicts.

![Git](https://img.shields.io/badge/Git-6D28D9?style=flat-square&logo=git&logoColor=white)
![Scrum](https://img.shields.io/badge/Scrum-7C3AED?style=flat-square)
![Full SDLC](https://img.shields.io/badge/Full_SDLC-4F46E5?style=flat-square)
...
![100 Days of Python](https://img.shields.io/badge/100_Days_of_Python_(Angela_Yu)-Udemy-6D28D9?style=flat-square&logo=udemy&logoColor=white)
![Full Stack Web Dev](https://img.shields.io/badge/Full--Stack_Web_Development-Udemy-7C3AED?style=flat-square&logo=udemy&logoColor=white)

**Google**

![Google Data Analytics](https://img.shields.io/badge/Data_Analytics_%26_Cloud_Engineering-Google_%2F_Coursera-4F46E5?style=flat-square&logo=google&logoColor=white)

**Forage — Industry Simulations**

![Walmart](https://img.shields.io/badge/Advanced_Software_Engineering-Walmart_Global_Tech-6D28D9?style=flat-square)
![Accenture](https://img.shields.io/badge/Software_Engineering-Accenture-7C3AED?style=flat-square)
![Deloitte](https://img.shields.io/badge/Data_Science_%26_Analyst-Deloitte-4F46E5?style=flat-square)
